...
export default function Home() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setOutput("");
    try {
      const promptText = "Tuition Planner: " + inputs["child_age"] + " | " + inputs["education_goals"] + " | " + inputs["current_savings"];
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 via-gray-950 to-gray-900 text-gray-100 py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-10">
          <h1 className="text-4xl font-bold text-emerald-400 mb-4">Tuition Planner</h1>
